...
Cinematic, calm, trustworthy. The product should feel low-distraction and intimate, with enough technical confidence that users understand what is happening without seeing raw engineering detail.

## Anti-references

Do not resemble Discord, Google Meet, a dashboard with a small video player, a browser-extension watch-party sidebar, a remote desktop app, or a marketing landing page. Cinema Mode must not use permanent sidebars or shrink the movie for chat, participants, settings, or call UI.
...
Use keyboard-accessible controls outside Cinema Mode, visible focus indicators, accessible names for controls, and text contrast suitable for WCAG AA. Do not rely only on color for status. Respect reduced motion and avoid persistent overlays that cover subtitles or important movie content.
